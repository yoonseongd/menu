...
import { Text,Dimensions, Linking,Button,View, Image, StyleSheet, StatusBar,ScrollView } from "react-native";
...
function Food() {
  return (
    ...
    <Image style={styles.image} source={require("../img/교촌신화.png")} />

    <View style={{flexDirection: 'row'}}>
      <View style={{margin:20}}>
      <Button
          title="요기요로 주문"
          onPress={() => Linking.openURL('https://www.yogiyo.co.kr/mobile/#/')} />   
      </View>
      <View style={{margin:20}}>
      <Button
          title="배달의민족 주문"
